...
<head>
    ...
    <title><?php echo e(is_array($seo) ? ($seo['title'] ?? 'Contact Us - ' . ($site['site_name'] ?? 'MyJob Portal')) : 'Contact Us - ' . ($site['site_name'] ?? 'MyJob Portal')); ?></title>
    <meta name="description" content="<?php echo e(is_array($seo) ? ($seo['description'] ?? 'Contact us for more information') : 'Contact us for more information'); ?>">
    <meta name="keywords" content="<?php echo e(is_array($seo) ? ($seo['keywords'] ?? 'contact us, contact information, customer service') : 'contact us, contact information, customer service'); ?>">
    ...
    <meta property="og:title" content="<?php echo e(is_array($seo) ? ($seo['title'] ?? 'Contact Us - ' . ($site['site_name'] ?? 'MyJob Portal')) : 'Contact Us - ' . ($site['site_name'] ?? 'MyJob Portal')); ?>">
    <meta property="og:description" content="<?php echo e(is_array($seo) ? ($seo['description'] ?? 'Contact us for more information') : 'Contact us for more information'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo e(is_array($seo) ? ($seo['title'] ?? 'Contact Us - ' . ($site['site_name'] ?? 'MyJob Portal')) : 'Contact Us - ' . ($site['site_name'] ?? 'MyJob Portal')); ?>">
    <meta name="twitter:description" content="<?php echo e(is_array($seo) ? ($seo['description'] ?? 'Contact us for more information') : 'Contact us for more information'); ?>">
    ...
    <?php if(isset($structuredData['faq'])): ?>
    <script type="application/ld+json">
        <?php echo json_encode($structuredData['faq'], JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer-widget">
                        ...
                        <p><?php echo e($site['site_description'] ?? 'Connecting great talents with the best job opportunities'); ?></p>
                        <div class="social-icons">
                            <a href="#" class="social-icon"><i class="fa fa-weibo"></i></a>
                            <a href="#" class="social-icon"><i class="fa fa-wechat"></i></a>
                            <a href="#" class="social-icon"><i class="fa fa-linkedin"></i></a>
...
</html><?php /**PATH /www/wwwroot/default_com/resources/views/pages/contact.blade.php ENDPATH**/ ?>
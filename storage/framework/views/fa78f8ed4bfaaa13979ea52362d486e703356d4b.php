...
<head>
    ...
    <title><?php echo e(is_array($seo) ? ($seo['title'] ?? 'About Us - ' . ($site['site_name'] ?? 'MyJob Portal')) : 'About Us - ' . ($site['site_name'] ?? 'MyJob Portal')); ?></title>
    <meta name="description" content="<?php echo e(is_array($seo) ? ($seo['description'] ?? 'Learn about our mission and values') : 'Learn about our mission and values'); ?>">
    <meta name="keywords" content="<?php echo e(is_array($seo) ? ($seo['keywords'] ?? 'about us, company introduction, team, mission') : 'about us, company introduction, team, mission'); ?>">
    ...
    <meta property="og:title" content="<?php echo e(is_array($seo) ? ($seo['title'] ?? 'About Us - ' . ($site['site_name'] ?? 'MyJob Portal')) : 'About Us - ' . ($site['site_name'] ?? 'MyJob Portal')); ?>">
    <meta property="og:description" content="<?php echo e(is_array($seo) ? ($seo['description'] ?? 'Learn about our mission and values') : 'Learn about our mission and values'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo e(is_array($seo) ? ($seo['title'] ?? 'About Us - ' . ($site['site_name'] ?? 'MyJob Portal')) : 'About Us - ' . ($site['site_name'] ?? 'MyJob Portal')); ?>">
    <meta name="twitter:description" content="<?php echo e(is_array($seo) ? ($seo['description'] ?? 'Learn about our mission and values') : 'Learn about our mission and values'); ?>">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer-widget">
                        ...
                        <p><?php echo e($site['site_description'] ?? 'Connecting outstanding talents with the best job opportunities'); ?></p>
...
</html><?php /**PATH /www/wwwroot/default_com/resources/views/pages/about.blade.php ENDPATH**/ ?>